...
export declare const isCodeRefError: (ref: CodeRef<any>) => boolean;
export declare const getCodeRefError: (ref: CodeRef<any>) => any;
export declare const setCodeRefError: (ref: CodeRef<any>, e: any) => CodeRef<any>;
/**
